...
-   [SCORE homepage](https://scorenetwork.org/){target="_blank"}
    ...
    -   [Data Github repository](https://data.scorenetwork.org/){target="_blank"}
        -   Curates interesting datasets across a variety of sports for use in statistics and data science education.
...
## 09:00 Joining the Network as a contributor
