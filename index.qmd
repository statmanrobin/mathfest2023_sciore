...
-   Session webpage [https://statmanrobin.github.io/mathfest2023_score/](https://statmanrobin.github.io/mathfest2023_score/){target="_blank"}
-   Presenters
    -   Nick Clark, Andrew Lee (US Military Academy)
    -   Robin Lock (St. Lawrence University)
-   Introductions

## 08:05 [Score (with Data) Network Overview](https://docs.google.com/presentation/d/1_RbVviK7sHRPXtDTL9m2-aCU4inwdsZQwFmtjX_I_GY/edit?usp=drive_link){target="_blank"}
...
-   [2023 JSM - Toronto](https://ww2.amstat.org/meetings/jsm/2023/){target="_blank"}
    ...
    -   [SCORE Seminar: Undergraduates Producing Sports-related Educational Modules](https://ww2.aievolution.com/JSMAnnual/index.cfm?do=ev.viewEv&ev=4708){target="_blank"} Contributed paper (August 7)

    -   [Sports, statistics, and science - such synergy! Using sports to support student success in statistics](https://ww2.aievolution.com/JSMAnnual/index.cfm?do=ev.viewEv&ev=2313) Topic Contributed Paper Session (August 9)

    -   [Teaching with Sports Examples and Data](https://docs.google.com/document/d/1trI7PGcJuc9qhEdX7Dx27rsdptDhfW6RfCD1GnjVTus/edit){target="_blank"} Birds of a Feather session (August 9)

-   [Post JSM - Virtual Birds of a Feather](https://docs.google.com/document/d/1trI7PGcJuc9qhEdX7Dx27rsdptDhfW6RfCD1GnjVTus/edit){target="_blank"} Teaching with Sports Examples and Data (August 14)
